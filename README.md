...
You are provided 3 mockups: desktop and tablet (same), mobile, and mobile with mobile menu dropdown shown. Your implementation has to be JUST 1 page. In other words, you will be creating a single, responsive page.
...
For this assignment, you are to use Twitter Bootstrap CSS Framework as much as possible.
...
(Hint: See https://getbootstrap.com/docs/3.3/components/#navbar for examples on how to accomplish this.)
